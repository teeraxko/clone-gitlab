...
namespace ictus.Framework.ASC.AppConfig
{
    ...
    {        
        ...
        //public static string REPORT_PATH = @"\\172.30.2.207\BTS\UATReport\";
        //public static string PHOTO_PATH = @"\\172.30.2.207\BTS\Photo\";
        ...
        //public static string PHOTO_PATH = @"\\172.30.2.207\BTS\BTSPhoto\";
        //public static string FTP_URL = @"ftp://bizpacftp:password@172.30.2.164:21/PTB/TestImport/";
