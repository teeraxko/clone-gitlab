...
{	
	...
	{	
		...
		private void InitializeComponent()
		{
			...
			this.cmdContractCancel.Text = "ยกเลิกสัญญา";
			...
			this.gpbContractCancel.Text = "เหตุผลในการยกเลิกสัญญา";
			// 
			// gpbContractInfo
			// 
        ...
        private bool checkContractStatus()
        {
            ...
            {
                Message(MessageList.Error.E0013, "ยกเลิกสัญญาได้", "สัญญาฉบับนี้ยังไม่ผ่านการอนุมัติ หรือได้ทำการยกเลิกไปแล้ว");
                cboContractStatus.Focus();
                return false;
            }
            if (cboCancelReason.Text.Trim() == "")
            {
                Message(MessageList.Error.E0002, "เหตุผลในการยกเลิกสัญญา");
        ...
        private void updateContract()
        {
            try
            {
                ...
                {
                    DialogResult result = Message(MessageList.Question.Q0002, "ยกเลิกสัญญา", "คืนข้อมูลกลับได้", "ยกเลิกสัญญานี้");
