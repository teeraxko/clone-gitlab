...
{
	public class frmrptExpiredDriverContractWithVehicle : ChildFormBase,IMDIChildForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.crvReport1.Location = new System.Drawing.Point(16, 75);
			...
			this.crvReport1.Size = new System.Drawing.Size(664, 440);
			this.crvReport1.TabIndex = 20;
			// 
			// groupBox1
			// 
			...
			// 
			// frmrptExpiredDriverContractWithVehicle
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(688, 518);
			this.Controls.Add(this.crvReport1);
			this.Controls.Add(this.groupBox1);
			this.Name = "frmrptExpiredDriverContractWithVehicle";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmrptExpiredDriverContractWithVehicle_Load);
		...
		public frmrptExpiredDriverContractWithVehicle()
		{
			InitializeComponent();
			facadeCompany = new CompanyFacade();
			this.Text = "รายงานพนักงานขับรถหมดสัญญา";
		}
		//		============================== Property ==============================
		...
		private void ReportDatabaseLogon()
		{
			try
			{
				...
				rdprint1.Load(@ApplicationProfile.REPORT_PATH + "rptExpiredDriverContractMatchWithVehicle.rpt");
		...
		private void frmrptExpiredDriverContractWithVehicle_Load(object sender, System.EventArgs e)
		{
