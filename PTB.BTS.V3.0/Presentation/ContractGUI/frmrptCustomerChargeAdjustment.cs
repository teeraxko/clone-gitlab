...
{
    public partial class frmrptCustomerChargeAdjustment : ChildFormBase, IMDIChildForm  
    {
        ...
        //======================================================================
        public frmrptCustomerChargeAdjustment() : base()
        {
            InitializeComponent();
        ...
        private void ReportDatabaseLogon()
        {
            try
            {
                ...
                rdprint1.Load(@ApplicationProfile.REPORT_PATH + "rptCustomerChargeAdjustmentDriver.rpt");
        ...
        private void frmrptCustomerChargeAdjustment_Load(object sender, EventArgs e)
        {
        ...
        private void frmrptCustomerChargeAdjustment_FormClosed(object sender, FormClosedEventArgs e)
        {
