...
namespace Presentation.VehicleGUI
{
	public class frmCompulsoryInsuranceByMonth : ChildFormBase, IMDIChildForm
	{
        ...
        private void InitializeComponent()
        {
            ...
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnCount = 12;
            ...
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(0, 6).CellType = textCellType2;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(0, 6).RowSpan = 2;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(0, 6).Text = "เลขที่ใบกำกับภาษี";
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(0, 7).RowSpan = 2;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(0, 7).Text = "วันที่ใบกำกับภาษี";
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(0, 8).RowSpan = 2;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(0, 8).Text = "ทะเบียนรถ";
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(0, 9).RowSpan = 2;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(0, 9).Text = "ยี่ห้อรถ";
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(0, 10).RowSpan = 2;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(0, 10).Text = "ลูกค้า";
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(0, 11).Text = "ค่าพ.ร.บ.";
            ...
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(1, 9).Text = "H";
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(1, 10).Text = "ลูกค้า";
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.ColumnHeader.Cells.Get(1, 11).Text = "(Total Premium)";
            ...
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(3).Width = 80F;
            ...
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(6).CellType = textCellType10;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(6).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(6).Width = 140F;
            ...
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(7).CellType = dateTimeCellType3;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(7).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(7).Width = 100F;
            ...
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(8).CellType = textCellType11;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(8).Locked = true;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(8).Width = 70F;
            ...
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(9).CellType = textCellType12;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(9).Label = "H";
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(9).Locked = true;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(9).Width = 70F;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(10).AllowAutoSort = true;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(10).BackColor = System.Drawing.Color.MistyRose;
            textCellType13.ButtonAlign = FarPoint.Win.ButtonAlign.Right;
            textCellType13.DropDownButton = false;
            textCellType13.ReadOnly = true;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(10).CellType = textCellType13;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(10).Label = "ลูกค้า";
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(10).Locked = true;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(10).Width = 95F;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(11).AllowAutoSort = true;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(11).BackColor = System.Drawing.Color.MistyRose;
            ...
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(11).CellType = numberCellType1;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(11).Label = "(Total Premium)";
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(11).Locked = true;
            this.fpsfrmCompulsoryInsuranceByMonth_Sheet1.Columns.Get(11).Width = 90F;
		...
		private void bindCompulsoryInsurance(int row, CompulsoryInsurance value)
		{
            ...
            fpsfrmCompulsoryInsuranceByMonth_Sheet1.Cells[row, 6].Text = "";
            fpsfrmCompulsoryInsuranceByMonth_Sheet1.Cells[row, 7].Text = GUIFunction.GetShortDateString(value.APeriod.To);
            fpsfrmCompulsoryInsuranceByMonth_Sheet1.Cells[row, 8].Text = value.AVehicle.PlateNumber;
            fpsfrmCompulsoryInsuranceByMonth_Sheet1.Cells[row, 9].Text = value.AVehicle.AModel.ABrand.AName.English;
			...
			if(value.AVehicle != null && value.AVehicle.AKindOfVehicle.Code != "Z")
			{
				...
				{
					fpsfrmCompulsoryInsuranceByMonth_Sheet1.Cells[row, 10].Text = contractBase.ACustomer.ShortName;				
				}
			}

			fpsfrmCompulsoryInsuranceByMonth_Sheet1.Cells[row, 11].Text = value.CompulsoryInsuranceAmount.ToString();
		}
		...
		private bool validateAdd()
		{
			...
			for(int i=0; i<fpsfrmCompulsoryInsuranceByMonth_Sheet1.RowCount; i++)
			{
				...
				if(fpsfrmCompulsoryInsuranceByMonth_Sheet1.Cells[i, 6].Text.Trim() == "")
				{
		...
		private bool addForm()
		{
			...
			for(int i=0; i<fpsfrmCompulsoryInsuranceByMonth_Sheet1.RowCount; i++)
			{
                ...
                compulsoryInsurance.TaxInvoiceNo = fpsfrmCompulsoryInsuranceByMonth_Sheet1.Cells[i, 6].Text;
                compulsoryInsurance.TaxInvoiceDate = DateTime.Parse(fpsfrmCompulsoryInsuranceByMonth_Sheet1.Cells[i, 7].Text);
