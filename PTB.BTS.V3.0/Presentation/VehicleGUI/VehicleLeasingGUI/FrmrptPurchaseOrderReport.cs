...
{
    public partial class FrmrptPurchaseOrderReport : ChildFormBase, IMDIChildForm
    {
        ...
        //============================== Constructor ==============================
        public FrmrptPurchaseOrderReport()
            : base()
        {
            InitializeComponent();
        ...
        public FrmrptPurchaseOrderReport(DocumentNo purchaseNo)
            : base()
        {
            InitializeComponent();
            this.Text = "Purchase Order Report";
            hidPurchaseNo.Text = purchaseNo.ToString();
        }
        ...
        private void ReportDatabaseLogon()
        {
            try
            {
                ...
                rdprint1.Load(@ApplicationProfile.REPORT_PATH + "rptVehiclePurchasingOrder.rpt");
                ...
                rdprint1.DataDefinition.ParameterFields["@pPurchaseNo"].ApplyCurrentValues(CrytalParameterValue(hidPurchaseNo.Text));
