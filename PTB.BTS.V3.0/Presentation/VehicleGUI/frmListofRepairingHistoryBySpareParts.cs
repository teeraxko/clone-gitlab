...
{
	public class frmListofRepairingHistoryBySpareParts : ChildFormBase,IMDIChildForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.crvPrint.Location = new System.Drawing.Point(14, 112);
			...
			this.crvPrint.Size = new System.Drawing.Size(1000, 600);
			...
			// btnShow
			// 
			this.btnShow.Location = new System.Drawing.Point(360, 56);
			...
			this.dtpTimeEnd.Location = new System.Drawing.Point(240, 56);
			...
			this.dtpTimeStart.Location = new System.Drawing.Point(128, 56);
			...
			// 
			// frmListofRepairingHistoryBySpareParts
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(1028, 746);
			this.Controls.Add(this.crvPrint);
			this.Controls.Add(this.groupBox1);
			this.Name = "frmListofRepairingHistoryBySpareParts";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmListofRepairingHistoryBySpareParts_Load);
		...
		//		============================== Constructor ==============================
		public frmListofRepairingHistoryBySpareParts():base()
		{
			InitializeComponent();
			facadeCompany = new CompanyFacade();
			facadeSpareParts = new SparePartsFacade();
			this.Text = "รายงานประวัติการซ่อมตามรายการอะไหล่";
...
//		============================== Private Method ==============================
		private void ReportDatabaseLogon()
		{
			...
			{			
				...
				SpareParts cboItem = (SpareParts)cboSparePartName.SelectedItem;
				string Spare_Code = cboItem.Code;

				rdprint1.Load(@ApplicationProfile.REPORT_PATH + "rptRepairingHistoryBySpareParts.rpt");
				...
				rdprint1.DataDefinition.FormulaFields["Spare_Code"].Text = "'" +Spare_Code + "'";;
		...
		{
			if (cboSparePartName.SelectedIndex == -1 | cboSparePartName.Text == "")
			{
				Message(MessageList.Error.E0005, "รายการอะไหล่" );
				cboSparePartName.Focus();
				return false;
			}
			return true;
		}
...
//		==============================Base Event ==============================
		...
		private void frmListofRepairingHistoryBySpareParts_Load(object sender, System.EventArgs e)
		{
