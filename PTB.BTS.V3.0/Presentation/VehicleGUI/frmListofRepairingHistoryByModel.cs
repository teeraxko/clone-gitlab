...
{
	public class frmListofRepairingHistoryByModel : ChildFormBase,IMDIChildForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.crvPrint.Location = new System.Drawing.Point(16, 88);
			...
			this.crvPrint.Size = new System.Drawing.Size(1000, 632);
			this.crvPrint.TabIndex = 1;
			// 
			// frmListofRepairingHistoryByModel
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(1028, 746);
			this.Controls.Add(this.crvPrint);
			this.Controls.Add(this.groupBox1);
			this.Name = "frmListofRepairingHistoryByModel";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmListofRepairingHistoryByModel_Load);
...
//		============================== Constructor ==============================
		public frmListofRepairingHistoryByModel()
		{
			InitializeComponent();
			facadeCompany = new CompanyFacade();
			this.Text = "รายงานประวัติการซ่อมตามรุ่นรถ";
		...
		private void ReportDatabaseLogon()
		{
			try
			{
				...
				rdprint1.Load(@ApplicationProfile.REPORT_PATH + "rptRepairingHistoryByModel.rpt");
		...
		private void frmListofRepairingHistoryByModel_Load(object sender, System.EventArgs e)
		{
