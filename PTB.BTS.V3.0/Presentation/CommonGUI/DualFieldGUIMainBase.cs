...
{
	public class DualFieldGUIMainBase : ChildFormBase, IMDIChildForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.cmdAdd.Location = new System.Drawing.Point(240, 200);
			...
			this.cmdEdit.Location = new System.Drawing.Point(320, 200);
			...
			this.fpsDualField.Location = new System.Drawing.Point(8, 16);
			...
			this.fpsDualField.Size = new System.Drawing.Size(696, 168);
            ...
            this.fpsDualField.ClipboardOptions = FarPoint.Win.Spread.ClipboardOptions.AllHeaders;
			// 
			// fpsDualField_Sheet1
			// 
			...
			this.fpsDualField_Sheet1.Columns.Get(0).Width = 148F;
			...
			this.fpsDualField_Sheet1.Columns.Get(1).Width = 243F;
			...
			this.fpsDualField_Sheet1.Columns.Get(2).Width = 248F;
			this.fpsDualField_Sheet1.OperationMode = FarPoint.Win.Spread.OperationMode.Normal;
			...
			this.fpsDualField_Sheet1.SelectionPolicy = FarPoint.Win.Spread.Model.SelectionPolicy.MultiRange;
			...
			this.cmdDelete.Location = new System.Drawing.Point(400, 200);
			...
			this.Name = "DualFieldGUIMainBase";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.DualFieldGUIMainBase_Load);
		...
		protected DualFieldGUIEntryBase frmEntry;
		...
		protected DualFieldBase SelectedDualField
		{
			get
			{
				...
				//return (DualFieldBase) facadeMTB.ObjList.BaseGet(SelectedKey.Trim());
			}
		}
		#endregion
...
//		============================== Constructor ==============================
		public DualFieldGUIMainBase() : base()
		{
			InitializeComponent();
		}
//		============================== Private Method ==============================
        private void bindDualField(int row, ictus.Common.Entity.General.DualFieldBase value)
		{
		...
		private void bindForm()
		{
            ...
            fpsDualField_Sheet1.SetActiveCell(fpsDualField_Sheet1.RowCount, 0);
		}		
...
//		============================== Public Method ==============================
        public virtual bool AddRow(ictus.Common.Entity.General.DualFieldBase aDualFieldBase)
		{
        ...
        public virtual bool UpdateRow(ictus.Common.Entity.General.DualFieldBase aDualFieldBase)
		{			
...
//		============================== event ==============================
		...
		private void DualFieldGUIMainBase_Load(object sender, System.EventArgs e)
		{
