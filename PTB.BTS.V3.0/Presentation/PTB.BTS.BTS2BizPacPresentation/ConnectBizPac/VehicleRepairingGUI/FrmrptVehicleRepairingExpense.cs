...
{
    public partial class FrmrptVehicleRepairingExpense : ChildFormBase, IMDIChildForm
    {
        #region - private -
        ...
        ////		============================== Constructor ==============================
        public FrmrptVehicleRepairingExpense()
            : base()
        {
            InitializeComponent();
            facadeCompany = new CompanyFacade();
            this.Text = "Vehicle Repairing Expense";
        }
        ...
        private void ReportDatabaseLogon()
        {
            try
            {
                ...
                rdprint1.Load(@ApplicationProfile.REPORT_PATH + "rptVehicleRepairingExpense.rpt");
                ...
                crvRepairing.ReportSource = rdprint1;
            }
            catch (Exception ex)
            {
        ...
        private void FrmRepairingExpense_Load(object sender, EventArgs e)
        {
            mdiParent = (Presentation.frmMain)this.MdiParent;
            InitForm();
        }

        private void FrmrptVehicleRepairingExpense_FormClosed(object sender, FormClosedEventArgs e)
        {
            CloseReport(crvRepairing);
        }
    }
}