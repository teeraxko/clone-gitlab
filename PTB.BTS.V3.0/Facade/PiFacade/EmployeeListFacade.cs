...
{
	public class EmployeeListFacade : CommonPIFacadeBase
	{
		#region - Private -
...
//		============================== Public Method ==============================
		public bool DisplayAvailableEmployee()
		{
			objEmployeeList = new EmployeeList(GetCompany());
			return flowEmployee.FillAvailableEmployeeList(ref objEmployeeList, conditionEmployee);
		}
		
		public bool DisplayAllEmployee()
		{
			objEmployeeList = new EmployeeList(GetCompany());
			return flowEmployee.FillAllEmployeeList(ref objEmployeeList, conditionEmployee);
		}

		public bool DisplayAvailableServiceStaff()
		{
			objEmployeeList = new EmployeeList(GetCompany());
