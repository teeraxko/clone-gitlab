...
{
    /// <summary>
    /// This class not use : Woranai 2009/07/28
    /// </summary>
    public class VehicleTrProfitAndLostDB : DataAccessBase
    {
        ////============================== Private Method ==============================
        //private string getSQLInsert(VehicleProfitAndLost profitAndLost)
        //{
        ...
        ////============================== Public Method ==============================
        //public bool InsertProfitAndLost(List<VehicleProfitAndLost> listPL)
        //{
