...
{
    public class VehicleTrInterestCostDetailDB : DataAccessBase
    {
        //============================== Private Method ==============================
        private string getSQLInsert(VehicleInterestCost interestCost)
        {
        ...
        //============================== Public Method ==============================
        public bool InsertInterestCostDetail(List<VehicleInterestCost> listCost)
        {
