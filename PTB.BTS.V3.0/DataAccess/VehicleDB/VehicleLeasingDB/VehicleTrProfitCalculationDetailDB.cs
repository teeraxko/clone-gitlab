...
{
    public class VehicleTrProfitCalculationDetailDB : DataAccessBase
    {
        //============================== Private Method ==============================
        private string getSQLInsert(VehicleProfitCalDetail profitCalDetail)
        {
            ...
            //Group_Code
            stringBuilder.Append(GetDB(profitCalDetail.GroupCode.ToString()));
            stringBuilder.Append(", ");

            //Line			
            stringBuilder.Append(GetDB(profitCalDetail.Line.ToString()));
            stringBuilder.Append(", ");
        ...
        //============================== Public Method ==============================
        public bool InsertProfitCalDetail(List<VehicleProfitCalDetail> listCal)
        {
