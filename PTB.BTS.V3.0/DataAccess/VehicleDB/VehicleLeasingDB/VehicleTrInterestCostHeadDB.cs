...
{
    public class VehicleTrInterestCostHeadDB : DataAccessBase
    {
        //============================== Private Method ==============================
        private string getSQLInsert(VehicleInterestCostList listCost)
        {
        ...
        //============================== Public Method ==============================
        public bool InsertInterestCostHead(VehicleInterestCostList listCost)
        {
