...
{
	public class FormerEmployeeSpouseDB : DataAccessBase
	{
		#region - Constant -
...
//		============================== Constructor ==============================
		public FormerEmployeeSpouseDB() : base()
		{
		}
...
//		============================== Private Method ==============================
		...
		{
			StringBuilder stringBuilder = new StringBuilder("UPDATE Former_Employee_Spouse SET ");
		...
		{
			return " DELETE FROM Former_Employee_Spouse ";
		}
		...
		#region - Fill -
		private void fillFormerEmployeeSpouse(ref EmployeeSpouse value, SqlDataReader dataReader)
		{
		...
		private bool fillFormerEmployeeSpouse(ref EmployeeSpouse value, string sql)
		{
			bool result;
			...
			try
			{
				if (dataReader.Read())
				{
					fillFormerEmployeeSpouse(ref value, dataReader);
					result = true;
				}
				else
				{
...
//		============================== internal Method ==============================
//		#region - internal -
//		internal bool InsertFormerEmployeeSpouse(EmployeeSpouse value)
//		{
...
//		}
//
//		internal bool UpdateFormerEmployeeSpouse(EmployeeSpouse value, SqlTransaction transaction)
//		{
...
//		}
//
//		internal bool DeleteFormerEmployeeSpouse(EmployeeSpouse value, SqlTransaction transaction)
//		{
...
//		#endregion
//		============================== Public Method ==============================
		public EmployeeSpouse GetFormerEmployeeSpouse(Employee value)
		{
			objEmployeeSpouse = new EmployeeSpouse();
			if(FillFormerEmployeeSpouse(ref objEmployeeSpouse))
			{
		...
		public bool FillFormerEmployeeSpouse(ref EmployeeSpouse aEmployeeSpouse)
		{
			StringBuilder stringBuilder = new StringBuilder(getSQLSelect());
			stringBuilder.Append(getBaseCondition(aEmployeeSpouse.AEmployee));
			return fillFormerEmployeeSpouse(ref aEmployeeSpouse, stringBuilder.ToString());
		}

		public bool InsertFormerEmployeeSpouse(EmployeeSpouse value)
		{
			if (tableAccess.ExecuteSQL(getSQLInsert(value))>0)
			{return true;}
			else
		...
		public bool UpdateFormerEmployeeSpouse(EmployeeSpouse value)
		{
			StringBuilder stringBuilder = new StringBuilder(getSQLUpdate(value));
			stringBuilder.Append(getBaseCondition(value.AEmployee));
		...
		public bool DeleteFormerEmployeeSpouse(EmployeeSpouse value)
		{
			StringBuilder stringBuilder = new StringBuilder(getSQLDelete());
			stringBuilder.Append(getBaseCondition(value.AEmployee));
