...
{
	public class EmployeeAddressDB : DataAccessBase
	{		
		#region - Constant -
...
//		============================== Private Method ==============================
		...
		{
			StringBuilder stringBuilder = new StringBuilder("UPDATE Employee_Address SET ");
		...
		{
			return " DELETE FROM Employee_Address ";
		}

		#endregion

		#region - Fill -
		private void fillEmployeeAddress(ref EmployeeAddress value, SqlDataReader dataReader)
		{
		...
		private bool fillEmployeeAddress(ref EmployeeAddress value, string sql)
		{
			bool result;
			...
			try
			{
				if (dataReader.Read())
				{
					fillEmployeeAddress(ref value, dataReader);
					result = true;
				}
				else
				{result = false;}
		...
		private void UpdateSingleField(EmployeeAddress value)
		{
			StreetDB dbStreet = new StreetDB();
			Street street = new Street();
			street.Name = value.ARegisterAddress.StreetName.Name;
			...
			subDistrict.Name = value.ARegisterAddress.Tambon.Name;
			...
			district.Name = value.ARegisterAddress.District.Name;
			...
			province.Name = value.ARegisterAddress.Province.Name;
...
//		============================== internal Method ==============================
		#region - internal -
		internal bool MaintainEmployeeAddress(EmployeeAddress value)
		{
		...
		#endregion
//		============================== Public Method ==============================
		public EmployeeAddress GetEmployeeAddress(Employee value)
		{
			objEmployeeAddress = new EmployeeAddress();
			objEmployeeAddress.AEmployee = value;
			if(FillEmployeeAddress(ref objEmployeeAddress))
			{
		...
		public bool FillEmployeeAddress(ref EmployeeAddress value)
		{
			StringBuilder stringBuilder = new StringBuilder(getSQLSelect());
			stringBuilder.Append(getBaseCondition(value.AEmployee));
			return fillEmployeeAddress(ref value, stringBuilder.ToString());
		}

		public bool InsertEmployeeAddress(EmployeeAddress value)
		{
		...
		public bool UpdateEmployeeAddress(EmployeeAddress value)
		{
		...
		public bool DeleteEmployeeAddress(EmployeeAddress value)
		{
			StringBuilder stringBuilder = new StringBuilder(getSQLDelete());
			stringBuilder.Append(getBaseCondition(value.AEmployee));
