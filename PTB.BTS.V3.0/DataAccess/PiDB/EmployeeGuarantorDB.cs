...
{
	public class EmployeeGuarantorDB : DataAccessBase
	{
		#region - Constant -
...
//		============================== Constructor ==============================
		public EmployeeGuarantorDB() : base()
		{
		}
...
//		============================== Private Method ==============================
		...
		{
			return " SELECT Employee_No, Person_Name, Gender, Birth_Date, Occupation, Relationship, Current_Address_Line, Current_Street_Name, Current_Sub_District, Current_District, Current_Province, Current_Postal_Code, Current_Tel_No, Current_Fax_No FROM Employee_Guarantor ";
		}

		private string getSQLInsert(ReferencePerson value, Employee aEmployee)
		{
			StringBuilder stringBuilder = new StringBuilder(" INSERT INTO Employee_Guarantor (Company_Code, Employee_No, Person_Name, Gender, Birth_Date, Occupation, Relationship, Current_Address_Line, Current_Street_Name, Current_Sub_District, Current_District, Current_Province, Current_Postal_Code, Current_Tel_No, Current_Fax_No, Process_Date, Process_User) ");
		...
		{
			StringBuilder stringBuilder = new StringBuilder("UPDATE Employee_Guarantor SET ");
		...
		{
			return " DELETE FROM Employee_Guarantor ";
		}
		...
		#region - Fill -
		private void fillEmployeeGuarantor(ref ReferencePerson value, SqlDataReader dataReader)
		{
		...
		private bool fillEmployeeGuarantorList(ref EmployeeReferencePerson value, string sql)
		{
			bool result = false;
			...
			try
			{
				while (dataReader.Read())
				{
					...
					fillEmployeeGuarantor(ref objReferencePerson, dataReader);
		...
		private bool fillEmployeeGuarantor(ref ReferencePerson value, string sql)
		{
			bool result;
			SqlDataReader dataReader = tableAccess.ExecuteDataReader(sql);
			try
			{
				if (dataReader.Read())
				{
					fillEmployeeGuarantor(ref value, dataReader);
					result = true;
				}
				else
				{result = false;}
...
//		============================== internal Method ==============================
		#region - internal -
		internal bool MaintainEmployeeGuarantor(ReferencePerson value, Employee aEmployee)
		{
		...
		#endregion
//		============================== Public Method ==============================
		public ReferencePerson GetGuarantor(string personName, Employee aEmployee)
		{
			objReferencePerson = new ReferencePerson();
			objReferencePerson.AName.Thai = personName;

			if(FillEmployeeGuarantor(ref objReferencePerson, aEmployee))
			{
		...
		public bool FillEmployeeGuarantor(ref ReferencePerson aReferencePerson, Employee aEmployee)
		{
			StringBuilder stringBuilder = new StringBuilder(getSQLSelect());
			stringBuilder.Append(getBaseCondition(aEmployee));
			stringBuilder.Append(getKeyCondition(aReferencePerson));
			return fillEmployeeGuarantor(ref aReferencePerson, stringBuilder.ToString());
		}

		public bool FillEmployeeGuarantorList (ref EmployeeReferencePerson value)
		{
			StringBuilder stringBuilder = new StringBuilder(getSQLSelect());
			stringBuilder.Append(getBaseCondition(value.Employee));
			stringBuilder.Append(getOrderby());

			return fillEmployeeGuarantorList(ref value, stringBuilder.ToString());
		}

		public bool InsertEmployeeGuarantor(ReferencePerson value, Employee aEmployee)
		{
		...
		public bool UpdateEmployeeGuarantor(ReferencePerson value, Employee aEmployee)
		{
		...
		public bool DeleteEmployeeGuarantor(ReferencePerson value, Employee aEmployee)
		{
			StringBuilder stringBuilder = new StringBuilder(getSQLDelete());
			stringBuilder.Append(getBaseCondition(aEmployee));
