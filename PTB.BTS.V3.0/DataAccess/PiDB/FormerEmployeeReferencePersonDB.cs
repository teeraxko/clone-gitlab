...
{
	public class FormerEmployeeReferencePersonDB : DataAccessBase
	{
		#region - Constant -
...
//		============================== Constructor ==============================
		public FormerEmployeeReferencePersonDB() : base()
		{
		}
...
//		============================== Private Method ==============================
		...
		{
			return " SELECT Employee_No, Person_Name, Gender, Birth_Date, Occupation, Relationship, Current_Address_Line, Current_Street_Name, Current_Sub_District, Current_District, Current_Province, Current_Postal_Code, Current_Tel_No, Current_Fax_No FROM Former_Employee_Reference_Person ";
		}

		private string getSQLInsert(ReferencePerson value, Employee aEmployee)
		{
			StringBuilder stringBuilder = new StringBuilder("INSERT INTO Former_Employee_Reference_Person (Company_Code, Employee_No, Person_Name, Gender, Birth_Date, Occupation, Relationship, Current_Address_Line, Current_Street_Name, Current_Sub_District, Current_District, Current_Province, Current_Postal_Code, Current_Tel_No, Current_Fax_No, Process_Date, Process_User) ");
		...
		{
			StringBuilder stringBuilder = new StringBuilder("UPDATE Former_Employee_Reference_Person SET ");
		...
		{
			return " DELETE FROM Former_Employee_Reference_Person ";
		}
		...
		#region - Fill -
		private void fillFormerEmployeeReferencePerson(ref ReferencePerson value, SqlDataReader dataReader)
		{
		...
		private bool fillFormerEmployeeReferencePersonList(ref EmployeeReferencePerson value, string sql)
		{
			bool result = false;
			...
			try
			{
				while (dataReader.Read())
				{
					...
					fillFormerEmployeeReferencePerson(ref objReferencePerson, dataReader);
		...
		private bool fillFormerEmployeeReferencePerson(ref ReferencePerson value, string sql)
		{
			bool result;
			SqlDataReader dataReader = tableAccess.ExecuteDataReader(sql);
			try
			{
				if (dataReader.Read())
				{
					fillFormerEmployeeReferencePerson(ref value, dataReader);
					result = true;
				}
				else
				{
...
//		============================== internal Method ==============================
//		#region - internal -
//		internal bool InsertFormerEmployeeReferencePerson(ReferencePerson value, Employee aEmployee, SqlTransaction transaction)
//		{
...
//		}
//
////		internal bool UpdateFormerEmployeeReferencePerson(ReferencePerson value, Employee aEmployee)
////		{
...
////		}
//
//		internal bool DeleteFormerEmployeeReferencePerson(ReferencePerson value, Employee aEmployee)
//		{
...
//		#endregion
		...
		public ReferencePerson GetReferencePerson(string personName, Employee aEmployee)
		{
			...
			if(FillFormerEmployeeReferencePerson(ref objReferencePerson, aEmployee))
			{
		...
		public bool FillFormerEmployeeReferencePerson(ref ReferencePerson value, Employee aEmployee)
		{
			StringBuilder stringBuilder = new StringBuilder(getSQLSelect());
			stringBuilder.Append(getBaseCondition(aEmployee));
			stringBuilder.Append(getKeyCondition(value));
			return fillFormerEmployeeReferencePerson(ref value, stringBuilder.ToString());
		}

		public bool FillFormerEmployeeReferencePersonList (ref EmployeeReferencePerson value)
		{
			StringBuilder stringBuilder = new StringBuilder(getSQLSelect());
			stringBuilder.Append(getBaseCondition(value.Employee));
			stringBuilder.Append(getOrderby());

			return fillFormerEmployeeReferencePersonList(ref value, stringBuilder.ToString());
		}

		public bool InsertFormerEmployeeReferencePerson(ReferencePerson value, Employee aEmployee)
		{
		...
		public bool UpdateFormerEmployeeReferencePerson(ReferencePerson value, Employee aEmployee)
		{
			StringBuilder stringBuilder = new StringBuilder(getSQLUpdate(value, aEmployee));
			stringBuilder.Append(getBaseCondition(aEmployee));
			stringBuilder.Append(getKeyCondition(value));
		...
		public bool DeleteFormerEmployeeReferencePerson(ReferencePerson value, Employee aEmployee)
		{
			StringBuilder stringBuilder = new StringBuilder(getSQLDelete());
			stringBuilder.Append(getBaseCondition(aEmployee));
			stringBuilder.Append(getKeyCondition(value));
